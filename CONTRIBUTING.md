...
This document is adapted from [GDAL’s AI/LLM user policy](https://gdal.org/en/stable/community/ai_tool_policy.html) which is a quasi direct adaptation from the [LLVM software "AI Tool Use Policy"](https://github.com/llvm/llvm-project/blob/main/llvm/docs/AIToolPolicy.md), and due credits go to its original authors: Reid Kleckner, Hubert Tong and "maflcko"